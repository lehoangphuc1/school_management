...
<div class="card" style="margin:10px 0px 0px 15px">
    ...
    <h4 class="card-title">Thêm kết quả học </h4>
    </div>
    ...
    <div class="card-body">
        ...
        @endif
        <form class="form form-vertical" method="post" action="{{ route('assign.subject.store') }}">
         @csrf   
        <div class="form-body">
                    ...
                    <div class="col-md-3">
                        <div class="form-group has-icon-left">
                            ...
                            <div class="col-md-10 position-relative">
                                <input type="text" name="subjective_mark[]" class="form-control" placeholder="Nhập vào điểm" id="first-name-icon">
                                <div class="form-control-icon" style="left: 10px">
                                    <i data-feather="clipboard"></i>
                                </div>
                            </div>
